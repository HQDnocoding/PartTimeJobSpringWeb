...
public class CandidateReviewRepositoryImplement implements CandidateReviewRepository {
    ...
    public Map<String, Object> getListReview(Map<String, String> params, Integer candidateId) {
        ...
        Join<CandidateReview, Job> jobJoin = root.join("jobId");
        Join<Job, Application> applicationJoin = jobJoin.join("applicationCollection");
        Join<Application, Candidate> candidateJoin = applicationJoin.join("candidateId");
